...
<html lang="en">
  <head>
    ...
    <title>Branch IT Complaint Portal | Complaint Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:white;">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-bookmark"></i> Complaint Details</h3>
            <hr />
...
<?php } ?>
 ...
 <div class="row mt">
            ...
            <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Engineer Assigned: </label>
              <div class="col-sm-10">
              <p><?php echo htmlentities($row['assigned']);?></p>
              </div>
