...
<html lang="en">
  <head>
    ...
    <title> Branch IT Complaint portal | Dashboard</title>
...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?><b> Complaints not Process yet</b></p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> <b>Complaints in process</b></p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?><b> Complaints has been closed</b></p>
                      </div>
