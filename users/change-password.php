...
<html lang="en">
  <head>
    ...
    <title>Branch IT Complaint Portal | User Change Password</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-bookmark"></i> Change Password</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-bookmark"></i> User Change Password</h4>
