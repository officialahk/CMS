...
<tr>
								...
								<tr>
											<td><b>Engineer Assigned </b></td>
											<td colspan="5"> <?php echo htmlentities($row['assigned']);?></td>
...
<td><b>Status</b></td>
											...
											<td colspan="5"><b style="color:red;"><?php if($row['status']=="")
...
<td colspan="5"><b style="color:red;"><?php echo  htmlentities($rw['sstatus']); ?></b></td>
</tr>
<?php }?>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/cms/engineer/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/cms/engineer/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
